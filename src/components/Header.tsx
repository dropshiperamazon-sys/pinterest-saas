...
import { Bell, Settings, User, Crown, CreditCard, LogOut, ChevronDown, Shield, Menu } from "lucide-react";
  ...
  return (
    <header className="bg-white border-b border-gray-100 px-4 sm:px-6 py-4 flex items-center justify-between sticky top-0 z-10">
      <div className="flex items-center gap-3 min-w-0">
        ...
        <button
          className="md:hidden p-2 -ml-1 rounded-lg text-gray-500 hover:bg-gray-100 transition-colors flex-shrink-0"
