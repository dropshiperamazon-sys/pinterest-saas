            ...
            {spacingLocked ? (
              <>
                ...
                <button onClick={() => setSpacingLocked(false)}
                  className="flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-semibold bg-gray-100 text-gray-600 hover:bg-gray-200 transition-colors">
              ...
              <>
                ...
                <button onClick={() => { applyPinSpacing(); setSpacingLocked(true); }}
                  className="px-2.5 py-1 rounded-lg text-xs font-semibold bg-blue-100 text-blue-700 hover:bg-blue-200 transition-colors">
                  Apply
                </button>
              </>
            )}
