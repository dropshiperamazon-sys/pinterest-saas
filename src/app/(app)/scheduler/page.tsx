            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden sticky top-20">
              ...
              <div className="px-3 pt-3 pb-2 border-b border-gray-100 flex flex-col gap-2">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {spacingLocked ? (
                    <div className="flex items-center gap-1.5">
                      <span className="px-2 py-0.5 rounded-md bg-blue-50 border border-blue-200 text-xs font-semibold text-blue-700">{pinSpacing}d</span>
                      <button onClick={() => setSpacingLocked(false)}
                        className="flex items-center gap-1 px-2 py-1 rounded-lg text-xs font-semibold bg-gray-100 text-gray-600 hover:bg-gray-200 transition-colors">
                    ...
                    <div className="flex items-center gap-1">
                      <button onClick={() => setPinSpacing(s => Math.max(1, s - 1))}
                        className="w-5 h-5 rounded border border-gray-200 text-gray-500 hover:bg-gray-50 text-xs flex items-center justify-center font-bold">−</button>
                      <span className="w-7 text-center text-xs font-semibold text-gray-800">{pinSpacing}d</span>
                      <button onClick={() => setPinSpacing(s => Math.min(30, s + 1))}
                        className="w-5 h-5 rounded border border-gray-200 text-gray-500 hover:bg-gray-50 text-xs flex items-center justify-center font-bold">+</button>
                      <button onClick={() => { applyPinSpacing(); setSpacingLocked(true); }}
                        className="ml-1 px-2.5 py-1 rounded-lg text-xs font-semibold bg-blue-100 text-blue-700 hover:bg-blue-200 transition-colors">
                        Apply
                      </button>
                    </div>
                  )}
